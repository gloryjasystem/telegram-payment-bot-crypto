    ...
    async def send_invoice_to_client(self, invoice: Invoice, user: User) -> bool:
        ...
        try:
            ...
            message_text = (
                ...
                f"ℹ️ <b>Важная информация:</b> На данный момент оплата услуг возможна через систему NOWPayments (криптовалюта). Приём платежей по банковским картам будет запущен в ближайшее время — сейчас идут технические работы.\n\n"
